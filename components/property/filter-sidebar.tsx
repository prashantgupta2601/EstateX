...
import { SlidersHorizontal, Check, RefreshCw, ChevronDown } from 'lucide-react';
    ...
    <div className={`flex flex-col gap-6 text-left ${className}`}>
      ...
      <div className="flex flex-col gap-2.5">
        <button
          ...
          className="flex items-center justify-between w-full text-left py-1 cursor-pointer focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary rounded-md"
        >
          <label className="text-sm font-bold text-muted-foreground cursor-pointer">Purpose</label>
          <ChevronDown className={`h-4 w-4 text-muted-foreground transition-transform duration-300 ${collapsed.purpose ? '-rotate-90' : ''}`} />
        </button>
        <div className={`grid transition-all duration-300 ease-in-out ${collapsed.purpose ? 'grid-rows-[0fr] opacity-0 pointer-events-none' : 'grid-rows-[1fr] opacity-100'}`}>
      ...
      <div className="flex flex-col gap-2.5">
        <button
          ...
          className="flex items-center justify-between w-full text-left py-1 cursor-pointer focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary rounded-md"
        >
          <label className="text-sm font-bold text-muted-foreground cursor-pointer">Price Range</label>
          <ChevronDown className={`h-4 w-4 text-muted-foreground transition-transform duration-300 ${collapsed.price ? '-rotate-90' : ''}`} />
        </button>
        <div className={`grid transition-all duration-300 ease-in-out ${collapsed.price ? 'grid-rows-[0fr] opacity-0 pointer-events-none' : 'grid-rows-[1fr] opacity-100'}`}>
          <div className="overflow-hidden">
      ...
      <div className="flex flex-col gap-2.5">
        <button
          ...
          className="flex items-center justify-between w-full text-left py-1 cursor-pointer focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary rounded-md"
        >
          <label className="text-sm font-bold text-muted-foreground cursor-pointer">Property Type</label>
          <ChevronDown className={`h-4 w-4 text-muted-foreground transition-transform duration-300 ${collapsed.type ? '-rotate-90' : ''}`} />
        </button>
        <div className={`grid transition-all duration-300 ease-in-out ${collapsed.type ? 'grid-rows-[0fr] opacity-0 pointer-events-none' : 'grid-rows-[1fr] opacity-100'}`}>
          <div className="overflow-hidden">
      ...
      <div className="flex flex-col gap-2.5">
        <button
          ...
          className="flex items-center justify-between w-full text-left py-1 cursor-pointer focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary rounded-md"
        >
          <label className="text-sm font-bold text-muted-foreground cursor-pointer">Bedrooms (BHK)</label>
          <ChevronDown className={`h-4 w-4 text-muted-foreground transition-transform duration-300 ${collapsed.bhk ? '-rotate-90' : ''}`} />
        </button>
        <div className={`grid transition-all duration-300 ease-in-out ${collapsed.bhk ? 'grid-rows-[0fr] opacity-0 pointer-events-none' : 'grid-rows-[1fr] opacity-100'}`}>
          <div className="overflow-hidden">
      ...
      <div className="flex flex-col gap-2.5">
        <button
          ...
          className="flex items-center justify-between w-full text-left py-1 cursor-pointer focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary rounded-md"
        >
          <label className="text-sm font-bold text-muted-foreground cursor-pointer">Amenities</label>
          <ChevronDown className={`h-4 w-4 text-muted-foreground transition-transform duration-300 ${collapsed.amenities ? '-rotate-90' : ''}`} />
        </button>
        <div className={`grid transition-all duration-300 ease-in-out ${collapsed.amenities ? 'grid-rows-[0fr] opacity-0 pointer-events-none' : 'grid-rows-[1fr] opacity-100'}`}>
          <div className="overflow-hidden">
            <div className="flex flex-col gap-2 max-h-[160px] overflow-y-auto pr-1 pt-1 pb-2">
      ...
      <div className="flex flex-col gap-2.5">
        <button
          ...
          className="flex items-center justify-between w-full text-left py-1 cursor-pointer focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary rounded-md"
        >
          <label className="text-sm font-bold text-muted-foreground cursor-pointer">Furnishing</label>
          <ChevronDown className={`h-4 w-4 text-muted-foreground transition-transform duration-300 ${collapsed.furnishing ? '-rotate-90' : ''}`} />
        </button>
        <div className={`grid transition-all duration-300 ease-in-out ${collapsed.furnishing ? 'grid-rows-[0fr] opacity-0 pointer-events-none' : 'grid-rows-[1fr] opacity-100'}`}>
          <div className="overflow-hidden">
            <div className="flex flex-col gap-2 pt-1 pb-2">
