      ...
      <div className="flex flex-col flex-1 p-4 md:p-5 gap-2">
        ...
        <div className="flex flex-wrap items-center justify-between mt-auto pt-3 border-t border-border/40 gap-y-3 gap-x-2">
          ...
          <div className="flex items-center gap-3.5 ml-auto sm:ml-0">
            ...
            <Link href={`/properties/${property.id}`} className="focus-visible:outline-none">
              <Button
                variant="outline"
                size="sm"
                className="rounded-xl font-semibold border-primary/20 text-primary hover:bg-primary/5 hover:text-primary cursor-pointer transition-colors focus-visible:ring-2 focus-visible:ring-primary"
              >
                View Details
              </Button>
            </Link>
